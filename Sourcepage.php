...
$releaseDate = $currentDate->format('Y-m-d');
...
$query = "SELECT * FROM student_data WHERE SystemID = '$SystemID'";
...
";
      ...
      <div class="jumboton px-2 mt-4">
        <div class="row">
            <div class="col-sm-6" >
            <div class="card text-center custom_tool_box m-0 text-left" >
                <div class="card-body">
                <h5 class="card-title text-center">Source Solution</h5>
                <hr>
...
<div class="form-group">
             ...
             <div class="col-sm-12 text-center" id="result_box" style="display:none;margin-bottom: 0px;">
        <button onclick="showtext()" type="button" class="btn btn-primary" style="margin-top: 30%;"id="checkBtn" class="btn">Convert</button>
                        </div>
        </form>
                </div>
    </div>
             ...
             <div class="card-body">
                <form action="Targetpage.php">
                  <table class="table table-bordered table-striped table-hover" id="myTable">
                    <thead>
                     <tr>
                        <th id="p1" class='text-center' scope='col'>Extracted Text  From Source Document
                        </th>
                                  </tr>
                                  <tr>
                                  
                                  <th class='text-center'  scope='col'><textarea id="txt" name="dat1" style="width: 100%;height:450px; border-color: Transparent;"></textarea></th>
                                  ...
                                  <th style="display:none" class='text-center'  scope='col'><textarea  name="rdate"><?php echo $releaseDate;?></textarea></th>
                ...
                <button type="submit" id="convert" class="btn btn-primary" style="display:block;margin-left: 40%;" name="x">Submit</button>
                                </form>
    ...
    <script src="vendorbootstrap4.1design.js"></script>
