...
if(isset($_POST['register_btn']))
{
    ...
    $memberimage = $_POST['aname'];
    $password=mysqli_real_escape_string($con,$_POST['password']);
    $password2=mysqli_real_escape_string($con,$_POST['confirmpassword']);
    $role="Teacher";
    $query = "SELECT * FROM rolebasedlogin WHERE email = '$email'";
        ...
        if( mysqli_num_rows($result) > 0)
        {
          ...
          else
          {
            ...
            {           //Create User
                ...
                $sql="INSERT INTO rolebasedlogin(Role,firstname,lastname,username,SystemID,DepartmentName,email,adress, password,gender,dob,aname) VALUES('$role','$firstname','$lastname','$username','$pin','$DepartmentName','$email','$adress','$password','$gender','$dob','$memberimage')"; 
...
<div class="signup-form">
    <form action="" method="post">
      ...
      <option name="DepartmentName">BS English</option>
        ...
        <div class="form-group">
        	<input type="email" class="form-control" name="email" placeholder="Email@.emailcom" required="required">
        </div>
        <div class="form-group">
        	<input type="text" class="form-control" name="adress" placeholder="City , Street , house no" required="required">
        </div>
         
        <div class="form-row mt-2 mb-4 ml-2">
                            <div class="column">
                                <div class="btn-group btn-group-toggle " data-toggle="buttons">
                                    ...
                                    <label class="btn btn-success ml-2" >
                                        <input type="radio" name="gender" value="Others" required="required"> others
                                    </label>
                                </div>
                            </div>
                        </div>

                        <div class="form-group"> Enter Date of birth
		...
		<div class="form-group">
            <button type="submit" name="register_btn" id="btnlg" class="btn btn-primary btn-lg">Create Examiner</button>
        </div>
