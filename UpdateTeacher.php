      ...
      while($row = mysqli_fetch_array($run_data))
                              ...
                              if(isset($_POST['update_btn']))
                              {
                                ...
                                $password=mysqli_real_escape_string($con,$_POST['password']);
                                  ...
                                  $update = "UPDATE rolebasedlogin SET firstname='$firstname', lastname = '$lastname', username = '$username', DepartmentName = '$DepartmentName', adress = '$adress',  password='$password' WHERE email='$email'";
...
<div id="updatefrm" class="signup-form">
        ...
        while($row = mysqli_fetch_array($run_data))
        {
            ...
            $sl = ++$i;
                                  ...
                                  if($Rolee=="Teacher"){
                                    ...
                                    echo" <script>document.getElementById('updatefrm').style.display='none';</script>";
?>
...
<div class="signup-form">
    <form action="" method="post">
        ...
        <div class="form-group">
			<div class="row">
				<div class="col"><input type="text" class="form-control"  name="firstname" value="<?php echo $fname?>" placeholder="<?php echo $fname?>" required="required"></div>
				<div class="col"><input type="text" class="form-control" name="lastname" value="<?php echo $lname?>" placeholder="<?php echo $lname?>" required="required"></div>
			</div>        	
        </div>
        <div class="form-group">
        	<input type="text" class="form-control" name="username" value="<?php echo $usernam ?>" placeholder="<?php echo $usernam ?>" required="required">
        </div>
       
        
        <div class="form-group">
    <select class="form-control" name="DepartmentName" value="<?php echo $Deptname ?>" >
     <option name="DepartmentName"><?php echo $Deptname ?></option>
      ...
      <option name="DepartmentName">BS English</option>
        ...
        <div class="form-group">
        	<input type="email" class="form-control" name="email" value="<?php echo $id ?>" placeholder="<?php echo $id ?>" required="required">
        </div>
        <div class="form-group">
        	<input type="text" class="form-control" name="adress" value="<?php echo $adreees ?>" placeholder="<?php echo $adreees ?>" required="required">
        </div>
		...
		<div class="form-group">
            <button type="submit" name="update_btn" id="btnlg" class="btn btn-primary btn-lg">Update Record</button>
        </div>
